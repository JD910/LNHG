...
class H5Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        with h5py.File(self.h5_path, 'r') as record:
            ...
            train_data = train_data[0::2,0::2]    #if 512*512 down_sampled to 1/2 of original size
    
            target_data = np.array(record[keys[index]]['target'])   
            target_data = target_data[0::2,0::2]  #if 512*512 down_sampled to 1/2 of original size
